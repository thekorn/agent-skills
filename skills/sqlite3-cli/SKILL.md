...
For an application database, inspect the target repository's configuration and
schema documentation to identify the same database file used by the running
application. Do not assume a conventional path or filename.
