...
- Follow the target repository's `AGENTS.md` or equivalent local instructions when present; this skill only defines the GitHub workflow around that repository-specific policy.
